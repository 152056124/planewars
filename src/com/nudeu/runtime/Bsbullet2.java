...
public class Bsbullet2 extends AbstractElf implements Moveable, Drawable {
    private Image image;
    private int speed = FrameConstant.GAME_SPEED * 3;

    public Bsbullet2(int x, int y, Image image) {
        super(x, y);
        this.image = image;
    }

    public Bsbullet2() {
        this(0,0, ImageMap.getImage("bb02"));
    }
    ...
    public void collisionCheck(MyPlane myPlane){
        ...
        if (myPlane.getRectangle().intersects(this.getRectangle())){
            ...
            frame.myPlane.setBloodVolue(frame.myPlane.getBloodVolue() - 1);//boss伤害翻倍
